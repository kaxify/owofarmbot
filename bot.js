...
rpc.on("ready", () => {
    ...
    rpc.setActivity({
        ...
        buttons: [
            {
                label: "Farm Bot",
                url: "https://github.com/kaxify/Owo-Farm-Bot",
            },
            {
                label: "Developer",
                url: "https://github.com/kaxify/",
            },
        ],
    });
});
...
console.log(
    chalk.cyan("github.com/kaxify\n") +
        chalk.cyan("Made with love for you\n") +
...
if (settings.banbypass) {
    ...
    console.log(
        chalk.yellow("Captcha (ban) Bypass System by Kaxify ") +
...
function checkversion() {
    ...
    if (fs.existsSync(versi)) {
        ...
        const versiun = https.get(
            "https://raw.githubusercontent.com/kaxify/owofarmbot/main/version.json",
            function (response) {
    ...
    setTimeout(() => {
        request.get(
            {
                url: "https://raw.githubusercontent.com/kaxify/owofarmbot/main/version.json",
            },
            function (err, res, body) {
                ...
                if (bod.updater === require("./version.json").updater) {
                    ...
                    const boti = https.get(
                        "https://raw.githubusercontent.com/kaxify/owofarmbot/main/updater.js",
                        function (response) {
                                ...
                                if (!global.etoken) {
                                    if (quest.includes("Say 'owo'")) {
                                        ...
                                        return questgamble(
                                            token,
                                            channelid,
                                            parseInt(progress1), //coded by @kaxify on github
                                            parseInt(progress2)
                                        );
                                    } else if (
                                    ...
                                    if (
                                        ...
                                        global.quest = false; //coded by @kaxify on github
                                        return questprayme(
                                            extratoken,
                                            maintokenuserid,
                                            channelid,
